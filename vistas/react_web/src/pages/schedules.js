                ...
                <div className="ml-64">
                    ...
                    <main className="my-8">
                        <div className="justify-center my-5 select-none flex">
                            ...
                            <button onClick={ this.handleOpenModal } type="button" className="mr-8 shadow-md no-underline font-black text-2xl rounded-full h-12 w-12 flex items-center justify-center bg-orange-600 text-white text-sm border-blue btn-primary hover:text-white hover:bg-green-500 focus:outline-none active:shadow-none">
                                        ...
                                        <p className="text-gray-800 font-medium">Nuevo Horario:</p>
                                            <div className="mt-2">
                                                ...
                                                <input className="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" 
                                                    type="text" 
                                                    placeholder="Seleccionar de las siguiente manera: 10:00 - 12:00" 
                                                    name="hora"
                                                    value={ hora }
