        ...
        return(
            <div>
                ...
                <div className="ml-64">
                    <hr />
                    <main className="my-8">
                        <p className="text-center my-5 text-2xl">Bienvenido a la seccion de actualizacion de peliculas.</p>
                        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 mx-8" onSubmit={ this.saveData }>
                            ...
                            <p className="text-red text-xs italic">Favor usted debe llenar toodos los campos.</p>
                            <div className="mt-4">
                                <button className="px-4 py-1 text-white font-light tracking-wider bg-green-600 hover:bg-blue-800 rounded" type="submit">Actualizar</button>
                            </div>
                        </form>
                    </main>
                </div>
