...
class Rooms extends Component {
    ...
    saveData = e => {
        ...
        if (this.post.datos.nombre === "" ||
          ...
          alert("Complete todos la informacion para continuar.");
        } else {
                ...
                <div className="ml-64">
                    ...
                    <main className="my-8">
                        <div className="justify-center my-5 select-none flex">
                            <p className="mt-5 text-center mr-10 text-2xl">Nueva Sala</p>
                            <button onClick={ this.handleOpenModal } type="button" className="mr-8 shadow-md no-underline font-black text-2xl rounded-full h-12 w-12 flex items-center justify-center bg-orange-600 text-white text-sm border-blue btn-primary hover:text-white hover:bg-green-600 focus:outline-none active:shadow-none">
                            ...
                            <ReactModal isOpen={this.state.showModal} contentLabel="onRequestClose Example" onRequestClose={this.handleCloseModal}
                                ...
                                <div className="leading-loose">
                                    <form className="max-w-xl m-4 p-10 bg-white rounded shadow-xl" onSubmit={ this.saveData }>
                                        <p className="text-gray-800 font-medium">Crear una nueva sala:</p>
                                            <div className="mt-2">
                                                <label className="block text-sm text-gray-600" htmlFor="nombre">Nombre de la sala:</label>
                                            ...
                                            <div className="mt-2">
                                                ...
                                                <input className="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" 
                                                    type="text" 
                                                    placeholder="Describir el aforo de la sala."
                                                    name="descripcion"
                                                    value={ descripcion }
                                                    onChange={ this.changeHandler }
                                                    autoComplete="off"
                                            ...
                                            <div className="mt-4">
                                                <button className="px-4 py-1 text-white font-light tracking-wider bg-green-600 hover:bg-blue-800 rounded" type="submit">Guardar</button>
                                            </div>
                                    </form>
                            ...
                            <table className="w-full text-md bg-white shadow-md rounded mb-4">
                                ...
                                <tbody>
                                    <tr className="border-b hover:bg-orange-100 bg-gray-100">
                                        ...
                                        <td>
                                            { salas.map(element => <p className="p-2 px-5" key={ element.id }><button onClick={ () => this.deleteData(element.id) } className="text-sm bg-red-600 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Eliminar</button></p> )}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
